...
function makeRow(
  overrides: Partial<MockInsightRow> & {
    spend: string;
    clicks: string;
    impressions: string;
    leads: number;
      ...
      leads > 0
        ? [
            ...
            { action_type: 'link_click', value: clicks.toString() },
            {
              ...
              value: Math.floor(clicks * 0.7).toString(),
            },
          ]
        : [{ action_type: 'link_click', value: clicks.toString() }],
...
export function generateMockChatData() {
  ...
  const todayCampaigns: MockInsightRow[] = [
    makeRow({
      campaign_id: '120211001',
      campaign_name: 'Lead Gen - Retargeting',
      spend: '85.20',
      impressions: '12400',
      clicks: '310',
      leads: 18,
    ...
    makeRow({
      campaign_id: '120211002',
      campaign_name: 'Broad Prospecting - US',
      spend: '245.60',
      impressions: '48000',
      clicks: '420',
      leads: 4,
      date: todayStr,
    }), // Problem: $245 spend, only 4 leads
    makeRow({
      campaign_id: '120211003',
      campaign_name: 'Instagram Stories Test',
      spend: '32.10',
      impressions: '8200',
      clicks: '175',
      leads: 3,
  ...
  const yesterdayCampaigns: MockInsightRow[] = [
    ...
    makeRow({
      ...
      leads: 14,
      date: yesterdayStr,
    }), // Was getting 14 leads yesterday
    makeRow({
      campaign_id: '120211003',
      campaign_name: 'Instagram Stories Test',
      spend: '28.40',
  ...
  const todayAdSets: MockInsightRow[] = [
    makeRow({
      adset_id: '230001',
      adset_name: 'Retarget - Website Visitors 30d',
      campaign_id: '120211001',
      spend: '52.30',
      impressions: '7800',
      clicks: '195',
    ...
    makeRow({
      adset_id: '230002',
      adset_name: 'Retarget - Engaged FB/IG 14d',
      campaign_id: '120211001',
      spend: '32.90',
      impressions: '4600',
      clicks: '115',
    ...
    makeRow({
      adset_id: '230003',
      adset_name: 'Broad - Interest: Business',
      campaign_id: '120211002',
      spend: '145.20',
      impressions: '28000',
      clicks: '240',
    ...
    makeRow({
      adset_id: '230004',
      adset_name: 'Broad - Lookalike 1% Leads',
      campaign_id: '120211002',
      spend: '100.40',
      impressions: '20000',
      clicks: '180',
    ...
    makeRow({
      adset_id: '230005',
      adset_name: 'IG Stories - Carousel',
      campaign_id: '120211003',
      spend: '32.10',
      impressions: '8200',
      clicks: '175',
